...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/jamesjwu/public_html/gre/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('assetic.asset_factory');
        $b = $this->get('templating.loader');
        $c = new \Assetic\Cache\ConfigCache('/home/jamesjwu/public_html/gre/app/cache/prod/assetic/config');
    ...
    {
        return $this->services['db_fetcher'] = new \GREReview\VocabBundle\DependencyInjection\DbFetcher($this->get('doctrine.dbal.default_connection'));
    }
    protected function getDictionaryService()
    {
        return $this->services['dictionary'] = new \GREReview\VocabBundle\DependencyInjection\MWAPIFetcher();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'jamesjwu_gre', 'host' => 'localhost', 'port' => NULL, 'user' => 'jamesjwu', 'password' => 'Iamthe1king', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home/jamesjwu/public_html/gre/app/cache/prod/jms_diextra/doctrine/EntityManager.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_534aa2244e410655ef55065e2644bb33');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_534aa2244e410655ef55065e2644bb33');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_534aa2244e410655ef55065e2644bb33');
        ...
        $d->setProxyDir('/home/jamesjwu/public_html/gre/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM50402b5141367_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/jamesjwu/public_html/gre/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/jamesjwu/public_html/gre/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/jamesjwu/public_html/gre/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/jamesjwu/public_html/gre/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/home/jamesjwu/public_html/gre/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['word_generator'] = new \GREReview\VocabBundle\DependencyInjection\WordGenerator($this->get('db_fetcher'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/jamesjwu/public_html/gre/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/jamesjwu/public_html/gre/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/jamesjwu/public_html/gre/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/jamesjwu/public_html/gre/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod',
            ...
            'kernel.bundles' => array(
                ...
                'GREReviewVocabBundle' => 'GREReview\\VocabBundle\\GREReviewVocabBundle',
            ),
            ...
            'session.save_path' => '/home/jamesjwu/public_html/gre/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/jamesjwu/public_html/gre/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/jamesjwu/public_html/gre/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/home/jamesjwu/public_html/gre/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/jamesjwu/public_html/gre/app/cache/prod/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM50402b5141367_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/home/jamesjwu/public_html/gre/app/cache/prod/jms_security',
